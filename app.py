...
AUTH_BASE_URL = os.environ.get("NUVU_BASE_URL", "https://nuvu-production.up.railway.app")
...
def login_submit():
    ...
    if email not in NUVU_ALLOWED_EMAILS:
        return render_template_string(
            LOGIN_HTML, msg="Email not recognised.", msg_ok=False
        )
...
# ─────────────────────────────────────────────────────────────
#  LOGIN GUARD — session check on all dashboard routes
# ─────────────────────────────────────────────────────────────
